...
class Dashboard_details_Screen {
	...
	def click_On_More_Options() {
		...
		MobileElement element = MobileElementCommonHelper.findElement(findTestObject('Object Repository/Android/Dashboard/More_Tab'), 10)
		element.click()
	}
}