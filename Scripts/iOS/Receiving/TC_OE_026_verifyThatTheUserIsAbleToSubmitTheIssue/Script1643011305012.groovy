...
'clicks on issue'
CustomKeywords.'iosReceiving.receivingReusableMethods.clickOnIssue'()

'verify invoice number visible while submission of issue'
CustomKeywords.'iosReceiving.receivingReusableMethods.verifyInvoiceNumberInIssue'(invoiceNumber)

'select reason of issue that can be missing or wrong tote'
CustomKeywords.'iosReceiving.receivingReusableMethods.selectReasonForIssue'(reasonOfIssue)

'enters detail for contact'
CustomKeywords.'iosReceiving.receivingReusableMethods.enterDetailsForContact'(name, phoneNumber, comment)

'clicks on submit issue'
CustomKeywords.'iosReceiving.receivingReusableMethods.clickOnSubmitIssue'()

'waits until the progressBar is visible on the screen'
CustomKeywords.'iosCommonKeywords.commonMethods.waitForProgressBarToBeInvisible'()

'verify submission of issue pop-up'
CustomKeywords.'iosReceiving.receivingReusableMethods.verifySubmissionOfIssue'()
...
'verify invoice number visible while submission of issue'
CustomKeywords.'iosReceiving.receivingReusableMethods.verifyShipmentNumberInIssue'(shipmentNumber)

'verifies details related to submission of issue and takes shipment number, tote id as the arguments'
CustomKeywords.'iosReceiving.receivingReusableMethods.verifyIssueSubmissionDetails'(toteID)
