...
CustomKeywords.'ios_inventory.Location_details_Screen.add_Product_to_Location'(Location_Name, Product_1)

CustomKeywords.'ios_inventory.Location_details_Screen.add_Product_to_Location'(Location_Name, Product_2)

CustomKeywords.'ios_common_keywords.Go_Back.Custom'()

CustomKeywords.'ios_common_keywords.Go_Back.Custom'()

CustomKeywords.'ios_inventory.Inventory_details_Screen.search_And_Add_Product_By_Creating_New_Location'(Location_Name_2, 
    Product_1, Cost_Type)
