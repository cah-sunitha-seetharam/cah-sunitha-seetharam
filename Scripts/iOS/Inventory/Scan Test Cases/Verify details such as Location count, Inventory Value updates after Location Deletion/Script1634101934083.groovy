...
CustomKeywords.'ios_inventory.Location_details_Screen.click_On_ScanIcon_And_Add_Product'(Product_Name, Count_Type, Quantity)

CustomKeywords.'ios_common_keywords.Go_Back.Custom'()

CustomKeywords.'ios_common_keywords.Go_Back.Custom'()

CustomKeywords.'ios_inventory.Inventory_details_Screen.delete_Location_With_Cost_LocationCount_Verification'(Location_Name)
