...
productSearch = requestObject[GlobalVariable.Environment].TC_OE_005.productSearchCin
...
'adds location in location details page and takes locationName as the argument'
CustomKeywords.'iosInventory.inventoryDetailsScreen.searchAndAddProductByCreatingNewLocation'(locationName_2,productSearch,costType_2,quantity)
