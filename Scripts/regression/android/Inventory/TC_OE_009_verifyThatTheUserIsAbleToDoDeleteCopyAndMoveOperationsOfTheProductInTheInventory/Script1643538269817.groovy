...
CustomKeywords.'androidInventory.locationDetailsScreen.addProductToLocation'(locationName_1, productSearch_1,quantity_1)
...
'adds products to a location'
CustomKeywords.'androidInventory.locationDetailsScreen.addProductToLocation'(locationName_2, productSearch_2,quantity_2)
...
'calling the function which moves a product to another location, it takes location and productName/UPC/Cin/Ndc as the argument'
CustomKeywords.'androidInventory.locationDetailsScreen.moveProductToAnotherLocation'(locationName_2, productSearch_2)

'waits until the progressBar is visible on the screen'
CustomKeywords.'androidCommonKeywords.commonMethods.waitForProgressBarToBeInvisible'()

'calling the function which deletes a product, it takes productName/UPC/Cin/Ndc as the argument'
CustomKeywords.'androidInventory.locationDetailsScreen.deleteProduct'(productSearch_2)

'waits until the progressBar is visible on the screen'
CustomKeywords.'androidCommonKeywords.commonMethods.waitForProgressBarToBeInvisible'()

'this function verifies that the product is visible on the location details screen'
CustomKeywords.'androidInventory.locationDetailsScreen.verifyProductIsNotVisibleOnTheLocationDetailsScreen'(productSearch_2)
