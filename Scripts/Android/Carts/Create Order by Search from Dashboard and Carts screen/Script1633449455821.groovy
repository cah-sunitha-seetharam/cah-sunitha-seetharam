...
CustomKeywords.'android_orders.Cart_Screen.delete_Order'(Account)

CustomKeywords.'android_dashboard.Dashboard_details_Screen.click_On_HomeTab'()

CustomKeywords.'android_dashboard.Dashboard_details_Screen.Adding_Product_from_Dashboard_To_Cart'(Product_Name, quantity)
