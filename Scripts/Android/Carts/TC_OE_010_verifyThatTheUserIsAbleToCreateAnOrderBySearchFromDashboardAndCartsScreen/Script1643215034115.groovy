...
CustomKeywords.'androidOrders.orderDetailsScreen.createNewOrderForC2'(poName1, poMemo1)
...
'searches for a product by setting product name and quantity as the input'
CustomKeywords.'androidOrders.orderDetailsScreen.searchProductInOrderDetailPage'(productSearch2)
