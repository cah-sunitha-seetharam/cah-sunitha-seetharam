...
CustomKeywords.'android_orders.Order_details_Screen.add_ALternate_Product'(Product_Name, quantity)

Mobile.pressBack()

CustomKeywords.'android_orders.Order_details_Screen.place_Order'()
