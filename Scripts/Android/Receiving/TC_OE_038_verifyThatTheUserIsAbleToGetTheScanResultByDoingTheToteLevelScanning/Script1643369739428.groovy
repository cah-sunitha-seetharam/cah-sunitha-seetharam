...
CustomKeywords.'androidReceiving.receivingReusableMethods.scanInputEvent'(eightDigitToteID)
...
String productSearch = requestObject[GlobalVariable.Environment].TC_OE_038.productSearchByNDC
...
//restrciting script to search with 8 digit toteID as 9 digit toteID not available