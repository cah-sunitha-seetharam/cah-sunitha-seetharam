...
CustomKeywords.'androidInventory.locationDetailsScreen.verify_Location_details_Screen'(Location_Name)

Mobile.pressBack()

CustomKeywords.'androidInventory.inventoryDetailsScreen.delete_Location'(Location_Name)
