...
CustomKeywords.'androidInventory.locationDetailsScreen.move_Product_To_Another_Location'(Location_2)

Mobile.pressBack()

CustomKeywords.'androidInventory.inventoryDetailsScreen.click_On_Location'(Location_2)

CustomKeywords.'androidInventory.locationDetailsScreen.add_Product_To_Location'(Location_2, Product_3)
...
CustomKeywords.'androidInventory.locationDetailsScreen.add_Product_To_Location'(Location_1, Product_4)
