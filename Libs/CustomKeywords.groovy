...
def static "ios_common_keywords.wait_for_load.Custom"() {
    (new ios_common_keywords.wait_for_load()).Custom()
}


def static "android_common_keywords.Scrolll.Custom"() {
    (new android_common_keywords.Scrolll()).Custom()
}
