...
def static "iosOrders.orderDetailsScreen.verifyValidationErrorAfterRemovingCharactesInUTNField"() {
 ...
 /**
	 * verifies only last 6 digit got deleted, first 3 characters could not be removed & validation error displayed after removing characters
	 */ 
def static "iosOrders.orderDetailsScreen.addAlternateProductVerfifyConfirmationToast"(
    	String productName	
     , 	String quantity	
     , 	String confirmationToastMessage	) {
    (new iosOrders.orderDetailsScreen()).addAlternateProductVerfifyConfirmationToast(
        	productName
         , 	quantity
 ...
 /**
	 ...
	 * @param productName (product to be added), quantity (total quantity required to be added)
	 */ 
def static "iosOrders.orderDetailsScreen.addProductToOrderAndContinueBrowsing"(
    	String productName	
     , 	String quantity	) {
    (new iosOrders.orderDetailsScreen()).addProductToOrderAndContinueBrowsing(
        	productName
         , 	quantity)
}
 ...
 /**
	 * places All order
	 */ 
def static "iosOrders.orderDetailsScreen.clickOnPlaceAllOrder"() {
    (new iosOrders.orderDetailsScreen()).clickOnPlaceAllOrder()
}
...
def static "androidOrders.orderDetailsScreen.verifyUploadOrderPopUp"() {
 ...
 /**
	 ...
	 * @param quantity (quantity of the product)
	 */ 
def static "androidOrders.orderDetailsScreen.addAlternateProductVerfifyConfirmationToast"(
    	String productName	
     , 	String quantity	
     , 	String confirmationToast	) {
    (new androidOrders.orderDetailsScreen()).addAlternateProductVerfifyConfirmationToast(
        	productName
         , 	quantity
         , 	confirmationToast)
}
...
def static "androidOrders.cartScreen.verifyOrderVisibleOnTheCartScreen"(
 ...
 /**
	 ...
	 */ 
def static "androidOrders.cartScreen.tapOnTopMostProductName"() {
    (new androidOrders.cartScreen()).tapOnTopMostProductName()
}
