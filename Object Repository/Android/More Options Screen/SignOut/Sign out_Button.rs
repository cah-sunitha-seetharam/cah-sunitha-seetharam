...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Sign out' or . = 'Sign out') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/positiveButton']</locator>
