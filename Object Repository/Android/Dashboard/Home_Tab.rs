...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Home' or . = 'Home') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/largeLabel']</locator>
