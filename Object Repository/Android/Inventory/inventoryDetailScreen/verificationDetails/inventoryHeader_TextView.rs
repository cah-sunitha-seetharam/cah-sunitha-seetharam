...
<MobileElementEntity>
   ...
   <name>inventoryHeader_TextView</name>
   <tag></tag>
   <elementGuidId>b5c9daac-e466-487f-b517-54286ad63500</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Inventory' or . = 'Inventory') and @resource-id = '${GlobalVariable.appPackage}:id/toolbarTitle']</locator>
