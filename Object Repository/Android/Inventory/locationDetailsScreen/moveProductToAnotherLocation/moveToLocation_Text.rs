...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>5d48247b-c50a-41df-8576-37ebfe3762b5</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${Location}' or . = '${Location}') and @resource-id = '${GlobalVariable.appPackage}:id/tvName']</locator>
