...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>86602a49-a94c-4b5f-a543-fc01fca40ffb</elementGuidId>
   <selectorCollection>
      <entry>
         <key>BASIC</key>
   ...
   <locator>//*[(@text = 'Add to ${Location}' or . = 'Add to ${Location}') and @resource-id = '${GlobalVariable.appPackage}:id/addToInventoryButton']</locator>
