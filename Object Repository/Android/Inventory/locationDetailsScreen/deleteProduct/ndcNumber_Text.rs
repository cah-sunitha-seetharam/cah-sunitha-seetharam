...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>25c537ad-8aea-4f03-89da-c483b89dad7f</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'NDC: ${TEXT}' or . = 'NDC: ${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/tvNdc']</locator>
