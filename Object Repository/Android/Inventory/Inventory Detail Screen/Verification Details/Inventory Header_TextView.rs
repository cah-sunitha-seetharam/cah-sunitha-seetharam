...
<MobileElementEntity>
   ...
   <name>Inventory Header_TextView</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Inventory' or . = 'Inventory') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/toolbarTitle']</locator>
