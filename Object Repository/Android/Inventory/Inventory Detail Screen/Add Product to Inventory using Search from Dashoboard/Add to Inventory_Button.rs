...
<MobileElementEntity>
   ...
   <selectorCollection>
      <entry>
         <key>BASIC</key>
         <value>//*[@class = 'android.widget.Button' and (text() = 'Add to Inventory' or . = 'Add to Inventory')]</value>
      </entry>
   </selectorCollection>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Add to Inventory' or . = 'Add to Inventory') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/btnPrimary']</locator>
