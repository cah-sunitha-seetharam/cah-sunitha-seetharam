...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - p9qRI6</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'p9qRI6' or . = 'p9qRI6') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/tvInventoryName']</locator>
