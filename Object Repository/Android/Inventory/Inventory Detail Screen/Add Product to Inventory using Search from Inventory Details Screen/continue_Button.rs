...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.Button' and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/continueBrowsingButton']</locator>
