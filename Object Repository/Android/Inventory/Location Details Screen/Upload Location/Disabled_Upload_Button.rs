...
<MobileElementEntity>
   ...
   <name>Disabled_Upload_Button</name>
   <tag></tag>
   <elementGuidId>56cd5d50-4d80-48c5-bd2d-8a6c75c5b336</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Upload' or . = 'Upload') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/btnUploadInventoryLocationItems' and @enabled = 'false']</locator>
