...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>784cb029-f657-446b-b302-b8915469c17d</elementGuidId>
   ...
   <locator>//*[(@text = 'Invoice : ${TEXT}' or . = 'Invoice : ${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/tvItemTitle']</locator>
