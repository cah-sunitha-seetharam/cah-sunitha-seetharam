...
<MobileElementEntity>
   ...
   <name>Account No_TextView</name>
   <tag></tag>
   <elementGuidId>fc155aed-be9e-4d1d-9d84-e19593736791</elementGuidId>
   <selectorCollection>
      <entry>
         <key>BASIC</key>
         <value>//*[@class = 'android.widget.TextView' and (text() = '${val}' or . = '${val}')]</value>
      </entry>
   </selectorCollection>
   ...
   <locator>//*[(@text = '${val}' or . = '${val}')]</locator>
