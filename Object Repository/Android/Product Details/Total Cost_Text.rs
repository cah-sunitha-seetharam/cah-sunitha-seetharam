...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>0ae377d3-79cf-4a15-b54c-e62fbecaea21</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and @resource-id = '${GlobalVariable.appPackage}:id/tvInvoiceCost']</locator>
