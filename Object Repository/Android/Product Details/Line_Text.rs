...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Line' or . = 'Line') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/tvInventoryItemLineText']</locator>
