...
<MobileElementEntity>
   ...
   <name>NDClabel_TextView</name>
   <tag></tag>
   <elementGuidId>89b1fff1-7485-4f30-9afd-ea661173c0b0</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and @resource-id = '${GlobalVariable.appPackage}:id/ndcTextView']</locator>
