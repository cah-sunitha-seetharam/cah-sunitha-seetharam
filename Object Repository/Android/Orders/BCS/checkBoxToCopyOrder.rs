...
<MobileElementEntity>
   ...
   <name>checkBoxToCopyOrder</name>
   <tag></tag>
   <elementGuidId>8157a4e5-8f45-403d-b669-c84aeb1aa24d</elementGuidId>
   ...
   <locator>${GlobalVariable.appPackage}:id/cbSavedOrder</locator>
