...
<MobileElementEntity>
   ...
   <name>cost_TextView</name>
   <tag></tag>
   <elementGuidId>9d38b040-d0e4-4d11-a024-d5842dbf65c4</elementGuidId>
   ...
   <locator>//*[@resource-id = '${GlobalVariable.appPackage}:id/tvOrderValue' and @bounds = '[${TEXT_1},${TEXT_2}][${TEXT_3},${TEXT_4}]']</locator>
