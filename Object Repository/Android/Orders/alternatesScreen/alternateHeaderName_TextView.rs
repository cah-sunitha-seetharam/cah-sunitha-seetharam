...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>7f4fb897-2212-464a-a30a-652996d6f252</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${TEXT}' or . = '${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/toolbarTitle']</locator>
