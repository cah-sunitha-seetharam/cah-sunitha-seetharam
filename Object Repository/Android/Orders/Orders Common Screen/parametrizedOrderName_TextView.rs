...
<MobileElementEntity>
   ...
   <name>parametrizedOrderName_TextView</name>
   <tag></tag>
   <elementGuidId>a479622d-d026-48b1-8f84-6e73c81b6fb4</elementGuidId>
   ...
   <locator>//*[(@text = '${TEXT}' or . = '${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/poNameTextView']</locator>
