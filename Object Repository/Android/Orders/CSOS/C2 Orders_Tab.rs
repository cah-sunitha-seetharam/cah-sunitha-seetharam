...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'C2 Orders' or . = 'C2 Orders') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/tvOrderType']</locator>
