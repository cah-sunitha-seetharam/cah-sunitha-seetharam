...
<MobileElementEntity>
   ...
   <name>Line_TextView</name>
   <tag></tag>
   <elementGuidId>c92bfd8a-251b-4678-8c3a-5213a25cf1a0</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/linesTextView']</locator>
