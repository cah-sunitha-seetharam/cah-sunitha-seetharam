...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Create a new order' or . = 'Create a new order') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/tvCreateOrder']</locator>
