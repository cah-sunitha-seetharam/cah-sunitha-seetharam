...
<MobileElementEntity>
   ...
   <name>Create new order_Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Create new order' or . = 'Create new order') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/btnCreateNewOrder']</locator>
