...
<MobileElementEntity>
   ...
   <name>Select Order_TextView</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Select Order' or . = 'Select Order') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/toolbarTitle']</locator>
