...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>0eac732c-b7a9-4de1-b69c-fa96648a2372</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'C2 Orders' or . = 'C2 Orders') and @resource-id = '${GlobalVariable.appPackage}:id/tvOrderType']</locator>
