...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>6b7d5a48-2930-4b1b-bdaa-be932a6226df</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and @resource-id = '${GlobalVariable.appPackage}:id/orderValueTextView']</locator>
