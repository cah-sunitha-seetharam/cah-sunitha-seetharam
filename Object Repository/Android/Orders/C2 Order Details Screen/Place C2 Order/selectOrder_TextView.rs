...
<MobileElementEntity>
   ...
   <name>selectOrder_TextView</name>
   <tag></tag>
   <elementGuidId>4b4872ca-a2b4-46ef-9bc6-cdd9246f77b5</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Select Order' or . = 'Select Order') and @resource-id = '${GlobalVariable.appPackage}:id/toolbarTitle']</locator>
