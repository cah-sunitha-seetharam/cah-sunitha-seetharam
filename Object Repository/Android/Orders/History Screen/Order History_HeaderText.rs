...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Order History' or . = 'Order History') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/toolbarTitle']</locator>
