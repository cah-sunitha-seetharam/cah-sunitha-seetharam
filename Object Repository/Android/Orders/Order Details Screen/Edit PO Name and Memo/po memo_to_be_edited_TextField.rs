...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>bcc0df6b-e5f4-42c3-9329-07f95e39e6ea</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '${po_memo}' or . = '${po_memo}') and @resource-id = '${GlobalVariable.appPackage}:id/poMemoEditText']</locator>
