...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>547de6b3-88a6-4ff1-be12-722ce60fd92e</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '${po_name}' or . = '${po_name}') and @resource-id = '${GlobalVariable.appPackage}:id/poNameEditText']</locator>
