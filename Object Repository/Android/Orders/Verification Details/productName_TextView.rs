...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>e1b41293-7fb2-4e76-9111-efa4672ca715</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${TEXT}' or . = '${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/productName']</locator>
