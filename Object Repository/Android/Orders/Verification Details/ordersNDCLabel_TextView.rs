...
<MobileElementEntity>
   ...
   <tag></tag>
   <elementGuidId>2a8ba73e-fdd7-42b5-9d82-1632aaa3e40c</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${TEXT}' or . = '${TEXT}') and @resource-id = '${GlobalVariable.appPackage}:id/ndcTextView']</locator>
