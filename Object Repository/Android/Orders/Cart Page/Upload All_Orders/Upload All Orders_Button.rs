...
<MobileElementEntity>
   ...
   <name>Upload All Orders_Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Upload All Orders' or . = 'Upload All Orders') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/continueAllOnDesktopButton']</locator>
