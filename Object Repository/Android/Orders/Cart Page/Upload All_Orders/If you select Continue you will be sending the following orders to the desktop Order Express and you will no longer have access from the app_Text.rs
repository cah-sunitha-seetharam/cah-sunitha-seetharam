...
<MobileElementEntity>
   ...
   <name>If you select Continue you will be sending the following orders to the desktop Order Express and you will no longer have access from the app_Text</name>
   <tag></tag>
