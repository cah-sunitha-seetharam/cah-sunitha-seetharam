...
<MobileElementEntity>
   ...
   <name>Cart Header_TextView</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Cart' or . = 'Cart') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/toolbarTitle']</locator>
