...
<MobileElementEntity>
   ...
   <name>Upload Order_Button</name>
   <tag></tag>
   <elementGuidId>52a9e275-0f65-467e-99f3-04953c71fc1a</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Upload Order' or . = 'Upload Order') and @resource-id = 'com.cardinalhealth.orderexpress.two.debug:id/btnUploadOrder']</locator>
